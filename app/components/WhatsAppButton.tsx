...
export default function WhatsAppButton() {
  return (
    <motion.a 
      ...
      className="fixed bottom-8 right-8 bg-[#25D366] text-white p-4 rounded-full shadow-[0_10px_40px_rgba(37,211,102,0.4)] z-[100] flex items-center justify-center group"
    >
